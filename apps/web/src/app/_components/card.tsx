...
/**
 * Authentic Hasbro Monopoly Deal 2024 Reference Card
 * Faithfully matches official reference card design:
 * - Bright chartreuse / lime-yellow border (#DEEB00)
 * - Inner frame with guilloche chevron background pattern (#FAF7E8)
 * - Vibrant orange-red "REFERENCE" header plaque with white double outline
 * - Structured sections: HOW TO WIN, SET UP, ON YOUR TURN (1, 2 [a,b,c], 3)
 * - Authentic footer copyright
 */
